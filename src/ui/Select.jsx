      ...
      <>
        ...
        <div className='mt-1 relative'>
          ...
          >
            <Listbox.Options
              static
              className='absolute z-30 mt-1 w-full bg-white dark:bg-gray-700 shadow-lg max-h-60 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm'
            >
              {_map(items, (item) => (
                <Listbox.Option
