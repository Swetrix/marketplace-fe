      ...
      <div className='-mt-px w-0 flex-1 flex group'>
        {
          page > 1 && (
            ...
            >
              <ArrowSmallLeftIcon className='mr-3 h-5 w-5 dark:group-hover:text-gray-400 group-hover:text-gray-700 dark:text-gray-300 text-gray-500 transition-none' aria-hidden='true' />
              { t('project.prev') }
            </button>
          )
          }
      ...
      <div className='-mt-px w-0 flex-1 flex justify-end group'>
        {
          page !== pageAmount && (
            ...
            >
              { t('project.next') }
              <ArrowSmallRightIcon className='ml-3 h-5 w-5 dark:group-hover:text-gray-400 group-hover:text-gray-700 dark:text-gray-300 text-gray-500 transition-none' aria-hidden='true' />
            </button>
          )
          }
      </div>
