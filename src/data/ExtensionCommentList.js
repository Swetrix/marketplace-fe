export const ExtensionCommentList = [
  {
    id: 1,
    icon: 'https://flowbite.com/docs/images/people/profile-picture-2.jpg',
    name: 'Michael Gough',
    data: 'Feb. 8, 2022',
    ...
    subComment: [
      {
        id: 1,
        icon: 'https://flowbite.com/docs/images/people/profile-picture-5.jpg',
        name: 'Jese Leos',
        data: 'Feb. 12, 2022',
        description: 'Much appreciated! Glad you liked it ☺️ Test 1',
        rating: '3'
      },
         {
        id: 2,
        icon: 'https://flowbite.com/docs/images/people/profile-picture-2.jpg',
        name: 'Jese Leos Test 2',
        data: 'Feb. 12, 2022',
        description: 'Much appreciated! Glad you liked it ☺️ Test 2',
        rating: '3'
      },
    ]
  },
  ...
  {
    id: 3,
    icon: 'https://flowbite.com/docs/images/people/profile-picture-4.jpg',
    name: 'Helene Engels',
    data: 'Jun. 23, 2022',
    ...
    rating: '2',
        subComment: [
      {
        id: 1,
        icon: 'https://flowbite.com/docs/images/people/profile-picture-5.jpg',
        name: 'Jese Leos Test 3',
        data: 'Feb. 12, 2022',
        description: 'Much appreciated! Glad you liked it ☺️ Test 3',
        rating: '3'
      }
    ]
  }
