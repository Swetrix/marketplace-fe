...
const ExtensionsCard = ({
  ...
  <div className='group max-w-[210px] w-full relative border rounded-sm p-3 bg-gray-100 dark:bg-gray-800 dark:border-gray-900  shadow-md'>
