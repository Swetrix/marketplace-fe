...
const ExtensionsCard = ({ name, stars, downloads, mainImage, price, companyLink, companyName, id }) => {
    ...
    >
      <div className='h-28 w-28 mx-auto aspect-w-1 aspect-h-1 rounded-md overflow-hidden group-hover:opacity-75 lg:aspect-none'>
        <img
          src={
            mainImage
              ? `${process.env.REACT_APP_CDN_URL}file/${mainImage}`
      ...
      <div className='mt-4'>
        ...
        <div className='flex justify-between items-center mt-1'>
          ...
          <div>
            <p className='text-indigo-700 dark:text-indigo-500 font-semibold'>{price === 0 ? 'Free' : `${price}$`}</p>
